    ...
    <div className="min-h-screen bg-[#fafafa] flex flex-col hp-bg">
      ...
      >
        ...
        <div className="max-w-2xl w-full flex flex-col items-center text-center gap-4">
          <span className="text-xs font-mono tracking-widest text-purple-400/80 uppercase">
          ...
          <p className="text-purple-200/70 font-sans text-base leading-relaxed">
            Connect any MCP-compatible AI assistant — Claude, Cursor, or your
            own agent — to a Polypad room. Describe what you want and watch
            shapes appear in real-time collaboration.
          </p>
        </div>
        ...
        <div className="max-w-3xl w-full grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {MCP_TOOLS.map((tool) => (
            ...
            >
              ...
              <p className="font-sans text-purple-200/60 text-xs leading-relaxed">
                {tool.desc}
              </p>
            </div>
          ))}
        ...
        <div className="max-w-2xl w-full flex flex-col gap-5">
          <h3 className="font-sans font-semibold text-white text-lg text-center">
          ...
          <ol className="flex flex-col gap-4 font-sans text-sm text-purple-200/80 list-none">
            <li className="flex gap-3">
              ...
              <span>
                Build the MCP server from the <a href="https://github.com/alexkhalevine/polypad.ink" target="_blank" className="text-purple-300 underline">repo</a>:
          ...
          <p className="text-center text-purple-300/50 font-sans text-xs">
            Replace <code className="text-purple-300/80">your-room-id</code>{" "}
            with the ID from any Polypad room URL.
          </p>
        </div>
      </section>
      ...
      <footer
        ...
        style={{ background: "rgba(10, 5, 40, 0.72)" }}
      >
